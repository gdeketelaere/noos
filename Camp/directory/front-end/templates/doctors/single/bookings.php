		...
		<div class="dc-modalcontent modal-content">
				...
				<section id="sec1" class="sec1">
						...
						<div id="dcModalBody1" class="dc-visitingdoctor">
							<form class="dc-booking-step1">
								...
								<div class="dc-appointment-holder">
									<div class="dc-title">
										<h4><?php esc_html_e('Select best time for appointment','doctreat');?></h4>
									</div>
					...
					<div id="dcModalBody4" class="modal-body dc-modal-content-four dc-haslayout">
						...
						<div class="dc-modal-body4-title">
							...
							<a href="javascript:;" class="dc-btn" data-dismiss="modal" aria-label="Close"><?php esc_html_e('Finish','doctreat');?></a>
							<?php } ?>
						</div>
					</div>
			...
			<?php } else { ?>
				<div class="dc-popuptitle">
					...
					<?php do_action('doctreat_empty_records_html','dc-empty-articls dc-emptyholder-sm',esc_html__( 'Doctor is not update his booking settings.', 'doctreat' ));?>
