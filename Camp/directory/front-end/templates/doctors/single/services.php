...
?>
<div class="dc-services-holder dc-aboutinfo tab-pane fade" id="campservices">
	<div class="dc-infotitle">
		<h3><?php _e('Offered Services','doctreat');?></h3>
	</div>
							...
							<span>
								<?php echo esc_html( $specialities_title );?>
								 <?php if( !empty( $service_count ) ){ ?>
									<em><?php echo intval($service_count);?><?php _e( 'Services','doctreat');?></em>
								 <?php } ?>
							 </span>
						</div>
					<?php } ?>
										...
										<?php if( !empty( $service_title ) ) { ?>
											<div class="dc-subpaneltitle">
												<span>
													...
													<em style="margin-right: 10px;"><?php echo $service_time.'min' ; ?></em>
													<?php } ?>
												</span>												
											</div>
										<?php } ?>
