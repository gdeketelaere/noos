					...
					<div class="dc-recentapointdate dc-recentapointdate-test">
						...
						<span>
							...
							<?php if(!empty( $appointment_date ) ) {?> 
								<em><?php echo date( $date_format,strtotime( $appointment_date ) );?></em>
							<?php } ?>
						</span>
					</div>
				</div>
		...
		<div class="dc-searchresult-head">
			...
			<?php if( !empty($booking_option) ){?>
				<div class="dc-rightarea">
					<a href="javascript:;" data-access="<?php echo esc_attr($system_access);?>" class="dc-btn dc-add-booking dc-btn-tab"><?php esc_html_e('Add booking','doctreat');?></a>
				</div>
			<?php } ?>
		</div>
...
<?php 
	...
	$inline_script = "var calendar_locale  = scripts_vars.calendar_locale;
