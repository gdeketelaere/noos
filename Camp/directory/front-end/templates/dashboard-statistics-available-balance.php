...
$available_balance_img	= !empty( $theme_settings['available_balance']['url'] ) ? $theme_settings['available_balance']['url'] : '';
	...
	<div class="dc-insightsitem dc-dashboardbox">
		<figure class="dc-userlistingimg">
			<?php if( !empty($available_balance_img) ) {?>
				<img src="<?php echo esc_url($available_balance_img);?>" alt="<?php esc_attr_e('Available Balance', 'doctreat'); ?>">
			<?php } else {?>
