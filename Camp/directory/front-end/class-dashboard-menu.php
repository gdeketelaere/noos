...
if (!class_exists('Doctreat_Profile_Menu')) {
    ...
    class Doctreat_Profile_Menu {
        ...
        public static function doctreat_profile_menu_top() {
			...
			if( !empty( $user_identity ) && $user_identity != 1 ){
            	ob_start();
				...
				$avatar = apply_filters('doctreat_doctor_avatar_fallback', doctreat_get_hospital_avatar(array('width' => 42, 'height' => 42), $link_id), array('width' => 42, 'height' => 42) 
										);
				?>
        ...
        public static function doctreat_profile_menu($menu_type = "dashboard-menu-left") {
			...
			$array_key_member=array('insights','profile-settings','account-settings','saved','logout');
        ...
        public static function doctreat_get_avatar() {
			...
			$avatar = apply_filters(
										'doctreat_doctor_avatar_fallback', doctreat_get_doctor_avatar(array('width' => 100, 'height' => 100), $link_id), array('width' => 100, 'height' => 100) 
									);
        ...
        public static function doctreat_get_user_info() {
			...
			$display_name	= get_the_title( $link_id );
			$profile_link	= get_the_permalink($link_id);
            ?>
            <div class="dc-title">
