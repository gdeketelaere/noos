...
$languages 	 	= !empty( $_GET['camp_languages']) ? $_GET['camp_languages'] :0;
$kids_friendly 	= !empty( $_GET['camp_kids_f']) ? $_GET['camp_kids_f'] : 0;
...
// Si kids friendy est spécifié
if ( !empty($kids_friendly) ) {
	$query_relation = array('relation' => 'OR',);
	$meta_queries = array(
		'key'     => 'camp_kids_f',
		'value'   => $kids_friendly,
	...
	$meta_query_args[] = array_merge($query_relation, $meta_queries);
}
